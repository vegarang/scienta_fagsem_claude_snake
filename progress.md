...
**Task 14 — Move pause button to stats bar; remove canvas score/level text** (2026-04-24)
- **Command**: Implement plan from `.air/plans/the-pause-button-score-cached-candy.plan.md`
